...
export const businesses: Business[] = [
  {
    ...
    province: "San Jose",
    city: "San Pedro",
    businessStyle: "Comida casera costarricense",
    offerSummary: "Casados, chifrijos, frescos naturales y almuerzos ejecutivos para oficina.",
    searchTags: ["soda", "casados", "almuerzos", "express", "comida tica"],
  },
  {
    id: "b_moda_tica",
    name: "Moda Tica",
    ...
    province: "San Jose",
    city: "Escazu",
    businessStyle: "Ropa casual femenina",
    offerSummary: "Blusas, jeans, basicos y outfits casuales con cambios coordinados.",
    searchTags: ["ropa", "moda", "blusas", "jeans", "outfits"],
  },
  {
    id: "b_farma_central",
    name: "Farma Central",
    ...
    province: "San Jose",
    city: "Rohrmoser",
    businessStyle: "Farmacia de barrio",
    offerSummary: "Medicamentos, vitaminas, cuidado personal y entregas programadas.",
    searchTags: ["farmacia", "vitaminas", "medicamentos", "salud", "entrega"],
  },
];
