...
drop policy if exists "businesses_member_or_public_store_select" on public.businesses;
...
drop policy if exists "businesses_owner_admin_update" on public.businesses;
...
drop policy if exists "business_members_owner_admin_insert" on public.business_members;
...
drop policy if exists "business_members_owner_admin_update" on public.business_members;
...
drop policy if exists "business_members_owner_admin_delete" on public.business_members;
...
drop policy if exists "stores_member_or_published_select" on public.stores;
...
drop policy if exists "stores_owner_admin_write" on public.stores;
...
drop policy if exists "categories_member_or_published_select" on public.product_categories;
...
drop policy if exists "products_member_or_published_select" on public.products;
...
drop policy if exists "orders_staff_or_courier_select" on public.orders;
...
drop policy if exists "order_items_staff_or_courier_select" on public.order_items;
...
drop policy if exists "delivery_zones_member_or_public_select" on public.delivery_zones;
...
drop policy if exists "couriers_member_or_self_select" on public.couriers;
...
create policy "couriers_admin_write" on public.couriers
  for all using (app_private.is_business_member(business_id, array['owner','admin']::public.business_role[]))
  with check (app_private.is_business_member(business_id, array['owner','admin']::public.business_role[]));
drop policy if exists "couriers_self_availability_update" on public.couriers;
create policy "couriers_self_availability_update" on public.couriers
  for update using (user_id = auth.uid()) with check (user_id = auth.uid());

drop policy if exists "deliveries_member_or_assigned_select" on public.deliveries;
...
drop policy if exists "deliveries_staff_or_assigned_update" on public.deliveries;
...
drop policy if exists "delivery_events_member_or_courier_select" on public.delivery_events;
...
drop policy if exists "delivery_events_member_or_courier_insert" on public.delivery_events;
...
drop policy if exists "crm_notes_staff_select" on public.crm_notes;
...
drop policy if exists "ai_logs_owner_admin_select" on public.ai_logs;
create policy "ai_logs_owner_admin_select" on public.ai_logs
  for select using (app_private.is_business_member(business_id, array['owner','admin']::public.business_role[]));
drop policy if exists "ai_logs_owner_admin_insert" on public.ai_logs;
...
drop policy if exists "delivery_proofs_member_or_courier_read" on storage.objects;
...
drop policy if exists "delivery_proofs_courier_write" on storage.objects;
